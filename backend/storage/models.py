...
class ChatMessage(Base):
    ...
    id = Column(Integer, primary_key=True, autoincrement=True)
    # module/context this message belongs to: 'inventory', 'orders', 'customers', 'general'
    context_type = Column(String(32), nullable=False, default='general', index=True)
    # optional reference to the related record (product id, order id, customer id)
